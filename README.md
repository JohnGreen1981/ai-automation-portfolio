...
Кейсы опубликованы как отдельные публичные репозитории, а этот репозиторий является витриной со ссылками на них.
...
- GitHub: [JohnGreen1981](https://github.com/JohnGreen1981)
